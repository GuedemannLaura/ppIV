...
results_A <- c(estimate_simA$IV_allprevprop_est, estimate_simA$IV_prev10prop_est, estimate_simA$IV_prev5prop_est, 
               estimate_simA$IV_prev2prop_est,   estimate_simA$IV_prevpatient_est,estimate_simA$IV_alldichmedian_est, 
               estimate_simA$IV_alldichmean_est, estimate_simA$IV_allprop_est)

results_B <- c(estimate_simB$IV_allprevprop_est, estimate_simB$IV_prev10prop_est, estimate_simB$IV_prev5prop_est, 
               estimate_simB$IV_prev2prop_est,   estimate_simB$IV_prevpatient_est,estimate_simB$IV_alldichmedian_est, 
               estimate_simB$IV_alldichmean_est, estimate_simB$IV_allprop_est)

results_C <- c(estimate_simC$IV_allprevprop_est, estimate_simC$IV_prev10prop_est, estimate_simC$IV_prev5prop_est, 
               estimate_simC$IV_prev2prop_est,   estimate_simC$IV_prevpatient_est,estimate_simC$IV_alldichmedian_est, 
               estimate_simC$IV_alldichmean_est, estimate_simC$IV_allprop_est)
...
Cairo(file = "Scenario2_simulationA_resultplot_subset_rulebasedmethods.png", 
      type = "png",
      units = "in", 
      width = 20, #10
      height = 16, # 16 
...
ggplot(data_plot) + 
  ...
  #+
  #ggtitle("Scenario 2 (simulation A): Missing mechanism")
  theme(
