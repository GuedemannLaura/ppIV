...
results_A <- c(estimate_simA$IV_star_est, estimate_simA$IVePP_rirs_est, estimate_simA$IV_ePP_est, estimate_simA$IV_PP_cc_est, 
               estimate_simA$IV_PP_est,   estimate_simA$CaT_cc_est)

results_B <- c(estimate_simB$IV_star_est, estimate_simB$IVePP_rirs_est, estimate_simB$IV_ePP_est, estimate_simB$IV_PP_cc_est, 
               estimate_simB$IV_PP_est,   estimate_simB$CaT_cc_est)

results_C <- c(estimate_simC$IV_star_est, estimate_simC$IVePP_rirs_est, estimate_simC$IV_ePP_est, estimate_simC$IV_PP_cc_est, 
               estimate_simC$IV_PP_est,   estimate_simC$CaT_cc_est)
...
Cairo(file = "Scenario2_simulationA_resultplot_subset_modelbasedmethods.png", 
      type = "png",
      units = "in", 
      width = 20, #10
      height = 16, # 16 
